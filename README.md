...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/eth-keyfile-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/eth-keyfile-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add eth-keyfile
# for installing globally
pixi global install eth-keyfile
```
...
It is possible to list all of the versions of `eth-keyfile` available on your platform:
...
```
pixi search eth-keyfile --channel conda-forge
```
