...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/eth-keyfile-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10593&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/eth-keyfile-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `eth-keyfile` can be installed with:

```
conda install eth-keyfile
```

It is possible to list all of the versions of `eth-keyfile` available on your platform with:
